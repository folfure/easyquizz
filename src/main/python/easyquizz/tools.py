...
class QuizzPlayer(object):
    ...
    def get_current_content(self):
        if self.section_id == -1:
            '''<div style="max-height:100vh;-webkit-animation: zoom 100s;animation: zoom 100s;"><center>
        ...
        <source src="/static/sound/justice.mp3" type="audio/mp4">
            ...
            return '''<div style="max-height:100vh">
                        <div id="slide" class="slide_text huge" style="font-size:20pt;position:relative;top:-25vh">
                            <center>TURBO BUZZ</center>
                        </div>
        ...
        <audio autoplay>
        <source src="/static/sound/kavinsky.mov" type="audio/mp4">
    </audio>
